...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryPlugin.template_argument'
        db.add_column('cmsplugin_categoryplugin', 'template_argument',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryPlugin.template_argument'
        db.delete_column('cmsplugin_categoryplugin', 'template_argument')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 12, 0, 0)'}),
